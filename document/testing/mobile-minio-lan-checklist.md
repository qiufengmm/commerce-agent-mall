...
| 4 | `http://<LAN_IP>:8088/h5/static/notice/ad1.jpg` | 成功返回图片 | 带 `/h5` 前缀的静态资源正常 |

### 3.2 本轮发现的问题

| 序号 | 地址 | 结果 | 结论 |
| --- | --- | --- | --- |
| 5 | `http://<LAN_IP>:8088/static/notice/ad1.jpg` | 失败 | H5 页面内按绝对路径请求 `/static/**`，Nginx 缺少对应映射 |
...
curl.exe -I "http://<LAN_IP>:8088/static/notice/ad1.jpg"
curl.exe -I "http://<LAN_IP>:8088/h5/static/notice/ad1.jpg"
```
...
| 路径 | 期望状态码 |
| --- | --- |
| `/static/notice/ad1.jpg` | `200` |
| `/h5/static/notice/ad1.jpg` | `200` |
