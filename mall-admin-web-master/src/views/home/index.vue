...
<template>
  <div class="app-container">
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">后端服务</div>
            <div class="color-main address-content">Spring Boot 3 + MyBatis</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">管理后台</div>
            <div class="color-main address-content">Vue 3 + Element Plus</div>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="out-border">
            <div class="layout-title">前台商城</div>
            <div class="color-main address-content">uni-app + Pinia</div>
          </div>
        </el-col>
      </el-row>
    </div>
    ...
    <el-card class="mine-layout">
      <div class="project-card-title">项目概览</div>
      <div class="project-card-line">核心链路：商品、购物车、订单、支付、发货</div>
      <div class="project-card-line">后续规划：接入智能导购与运营助手</div>
    </el-card>
