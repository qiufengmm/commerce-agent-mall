...
<template>
  <div>
    ...
    <el-dialog title="体验账号" v-model="dialogVisible" :show-close="false" :center="true" width="30%">
      <div style="text-align: center">
        <div class="font-title-large">本地演示账号</div>
        <div style="margin-top: 12px">用户名：<span class="color-main">admin</span></div>
        <div style="margin-top: 8px">密码请使用本地数据库初始化脚本中的管理员密码。</div>
      </div>
      <template #footer>
